                                        ...
                                        <section class="result-box" id="resultBox" hidden="" style="display: block;">
                                                ...
                                                <div class="result-success" id="success">
                                                    ...
                                                    <ul id="result" class="result-list">
                                                        ...
                                                        <c:forEach items="${logistics.Traces}" var="l" varStatus="i">

                                                        <li class="first">
                                                            <div class="col1">
                                                                <dl>
                                                                    <dt>${fn:split(l.AcceptTime," ")[0]}</dt>
                                                                    <dd>${fn:split(l.AcceptTime," ")[1]}</dd>
                                                                </dl>
                                                            </div>
                                                            <div class="col2"><span class="step"><span class="line1"></span><span class="line2"></span><span class="point"></span></span></div>
                                                            <div class="col3">${l.AcceptStation}
                                                            </div>
                                                        </c:forEach>
                                                    </ul>
                                                </div>
                                            <c:if test="${empty logistics.Traces }">
                                                <div class="result-fail" id="fail"  style="text-align: center;">
                                                    <h4>抱歉，该单号未能查询到结果。</h4>
